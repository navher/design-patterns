...
import com.kreitek.pets.utils.Logger;

import java.util.List;

public class CatController implements Controller {

    Logger logger = Logger.getInstance(); // TODO Logger declaration

    @Override
    public String executePut(String petName, String ownerName, String telephone) {
        logger.debug("CatController.executePut " + petName + "," + ownerName + "," + telephone);// TODO logger.debug("CatController.executePut " + petName + "," + ownerName + "," + telephone);
    ...
    public String executeGet() {
        logger.debug("CatController.executeGet CATS");// TODO logger.debug("CatController.executeGet CATS");
        DbService dbService = DbService.getInstance();
